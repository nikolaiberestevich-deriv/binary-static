            ...
            <div className='container' data-show='eucountry'>
                ...
                <div className='gr-row'>
                    <div className='gr-12'>
                        ...
                        <p>
                            {it.L('In the UK, virtual-events-based bets on synthetic indices are offered by Deriv (MX) Ltd, Millennium House, Level 1, Victoria Road, Douglas IM2 4RW, Isle of Man, licensed and regulated in the United Kingdom by the UK Gambling Commission [_1](account no. 39172).[_1]', '<a href="https://www.gamblingcommission.gov.uk/public-register/business/detail/39172" target="_blank" rel="noopener noreferrer">')}
                        </p>
                        <p>
